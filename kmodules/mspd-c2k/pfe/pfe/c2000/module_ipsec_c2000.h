...
#define SA_STATE_VALID 	0x1
#define SA_STATE_DEAD 0x2
#define SA_STATE_EXPIRED 0x3
#define SA_STATE_DIYNG 0x4
...
void M_IPsec_inbound_process_from_util(PMetadata mtd);
#endif
...
#if defined (COMCERTO_2000_UTIL)
#define UTIL_IPSEC_OUT_SA_BASE_ADDR  (&g_dmem_out_sa)
#define UTIL_IPSEC_IN_SA_BASE_ADDR  (&g_dmem_in_sa)
//static void M_ipsec_sa_expire_notify(PSAEntry sa, int hard);

/* Extern declarations required */
extern int is_room_available;
extern struct elp_wqentry  dmem_ddt ;
extern SACacheEntry  g_dmem_out_sa;
extern SACacheEntry  g_dmem_in_sa;
extern SAStatEntry g_sa_stats;
extern u8 upe_dmem_pkt[];
extern void util_ipsec_init();
extern TIMER_ENTRY sa_timer;
extern void sa_timer_handler(void);
#ifdef FPP_STATISTICS
