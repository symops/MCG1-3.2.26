...
#define RTP_TAKEOVER_TSINCR_FREQ 1
...
typedef struct _tStatsflow {
	...
	U32		cycles;
	U16		mode;
}Statsflow, *Pstatsflow;

typedef struct _tRTP_stats_entry
{
	U16 stream_id;
	U16 stream_type;
	void *private;
	...
	U16 dport;
	U16 proto;
	struct _tStatsflow flow;
	struct _tRTCPStats stats;
} RTP_STATS_ENTRY, *PRTP_STATS_ENTRY;
...
extern struct _tRTP_stats_entry RTP_STATS_TABLE[MAX_RTP_STATS_ENTRY];
...
void RTP_compute_stats(PMetadata mtd, udp_hdr_t *pUdpHdr, rtp_hdr_t *pRtpHeader, void *pEntry);
