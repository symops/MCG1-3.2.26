...
#ifdef WIFI_ENABLE
#define MAX_WIFI_VAPS 		2 
#define	MAX_PORTS		(GEM_PORTS + 1)
#define	PORT_WIFI_IDX		GEM_PORTS
#define	MAX_PHY_PORTS		(GEM_PORTS + MAX_WIFI_VAPS)
#define IS_WIFI_PORT(port_no)	((port_no >= PORT_WIFI_IDX) && (port_no < MAX_PHY_PORTS))
#else
#define MAX_PORTS		GEM_PORTS
#define	MAX_PHY_PORTS		GEM_PORTS 
#endif //WIFI_ENABLE
...
enum {
	...
	GEM2_PORT,
#ifdef WIFI_ENABLE
	WIFI0_PORT,            /* WIFI0_PORT = PORT_WIFI_IDX */
	EXPT_PORT =  WIFI0_PORT + MAX_WIFI_VAPS,
#else
	EXPT_PORT,
#endif
	MSP_PORT,
