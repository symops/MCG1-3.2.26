...
/* Conntrack status */
#define	CONNTRACK_RTP_STATS		0x1000
#define CONNTRACK_SEC			0x800
#define CONNTRACK_SEC_noSA     		0x400
#define CONNTRACK_TCP_FIN		0x200
#define CONNTRACK_TIMED_OUT		0x100
#define CONNTRACK_FF_DISABLED		0x80
#define CONNTRACK_MARKSWAP		0x20
#define CONNTRACK_NAT			0x10
#define CONNTRACK_SNAT			CONNTRACK_NAT
#define CONNTRACK_DNAT			0x08
#define CONNTRACK_IPv6			0x04
#define CONNTRACK_ORIG			0x02
...
/* TODO works on all targets and in all cases but isn't optimized on C2k PFE.
 * One of the addresses should always be aligned so we could take advantage of that.
 */
#define IPV6_CMP(addr1, addr2) ( \
	(READ_UNALIGNED_INT(((U32 *)addr1)[0]) - READ_UNALIGNED_INT(((U32 *)addr2)[0])) || \
	(READ_UNALIGNED_INT(((U32 *)addr1)[1]) - READ_UNALIGNED_INT(((U32 *)addr2)[1])) || \
	(READ_UNALIGNED_INT(((U32 *)addr1)[2]) - READ_UNALIGNED_INT(((U32 *)addr2)[2])) || \
	(READ_UNALIGNED_INT(((U32 *)addr1)[3]) - READ_UNALIGNED_INT(((U32 *)addr2)[3]))    \
	)


static __inline U32 GET_TIMEOUT_VALUE(U32 udp_flag, int bidir_flag)
{
	if (udp_flag)
	{
