...
/* Comcerto PWM */
#define COMCERTO_PWM_REG                    APB_VADDR(COMCERTO_APB_TIMER_BASE + 0x8000)
#define COMCERTO_MAX_EN_PWM0                APB_VADDR(COMCERTO_APB_TIMER_BASE + 0x8000 + 0x08)
#define COMCERTO_LOW_DUTY_PWM0              APB_VADDR(COMCERTO_APB_TIMER_BASE + 0x8000 + 0x0C)
#define COMCERTO_MAX_EN_PWM1                APB_VADDR(COMCERTO_APB_TIMER_BASE + 0x8000 + 0x10)
#define COMCERTO_LOW_DUTY_PWM1              APB_VADDR(COMCERTO_APB_TIMER_BASE + 0x8000 + 0x14)
#define COMCERTO_MAX_EN_PWM2                APB_VADDR(COMCERTO_APB_TIMER_BASE + 0x8000 + 0x18)
#define COMCERTO_LOW_DUTY_PWM2              APB_VADDR(COMCERTO_APB_TIMER_BASE + 0x8000 + 0x1C)
#define COMCERTO_MAX_EN_PWM3                APB_VADDR(COMCERTO_APB_TIMER_BASE + 0x8000 + 0x20)
#define COMCERTO_LOW_DUTY_PWM3              APB_VADDR(COMCERTO_APB_TIMER_BASE + 0x8000 + 0x24)
